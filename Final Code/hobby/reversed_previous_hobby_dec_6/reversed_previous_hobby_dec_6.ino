...
void loop() {
  ...
  // CHANGE 1: Forward is now values LESS than 1500 (1500 -> 600)
  bool isMovingForward = rc_values[RC_CH2] < 1500;
  
  // CHANGE 2: Reverse is now values GREATER than 1600 (1600 -> 2300)
  bool isMovingReverse = rc_values[RC_CH2] > 1600;
  ...
  int throttleSpeed = 0;
  if (isMovingForward) {
    // CHANGE 3: Map 1500 (stop) to 600 (full speed)
    throttleSpeed = map(rc_values[RC_CH2], 1500, 600, 50, 255);
  } else if (isMovingReverse) {
    // CHANGE 4: Map 1600 (stop) to 2300 (full speed)
